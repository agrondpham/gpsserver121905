...
<script type="text/javascript">
    $(document).ready(function () {
        $(function () {
            ...
            $("#ctl02_controller1_tbxStartTime").datepicker({
                showOn: "button",
            ...
            $("#ctl02_controller1_tbxStartTime").datepicker("option",
				$.datepicker.regional["vi"]);
            $("#ctl02_controller1_tbxStopTime").datepicker({
                showOn: "button",
                buttonImage: "../Themes/_default/Images/calendar_icon.png",
                buttonImageOnly: true,
                showAnim: "slide"
            ...
            //set location for time picker
            $("#ctl02_controller1_tbxStopTime").datepicker("option",
				$.datepicker.regional["vi"]);
        });
    });
...
<script type="text/javascript">
    ...
    $(function () {
        $("#ctl02_controller1_drdDevices").combobox();
    });
    $(function () {
        $("#ctl02_controller1_drdDevices2").combobox();
    });
</script>
<%--Button Jquery style--%>
<script type="text/javascript">
